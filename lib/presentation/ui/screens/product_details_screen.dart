      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration:
                BoxDecoration(color: AppColors.primaryColor.withOpacity(0.3),
            ...
            child: Row(
              ...
              children: [
                const Column(
                  ...
                  children: [
                    Text("Price"),
                    Text("\$204",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500,color: AppColors.primaryColor)),
                  ],
                ),
                SizedBox(
                   width: 120, child: ElevatedButton(onPressed: () {}, child: const Text("Add to Cart",style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal),)))
              ],
            ),
          ),
        ],
